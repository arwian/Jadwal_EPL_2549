package com.example.Jadwal_EPL_2549;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnFav.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                DataFaforit db = new DataFaforit(getApplicationContext());
                db.addFavorite(eventsItem);

                Toast.makeText(getApplicationContext(),"Favorite Ditambahkan : " + eventsItem.getStrEvent(), Toast.LENGTH_SHORT).show();
            }
        });
    }
